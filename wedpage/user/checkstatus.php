        ...
        <?php else :; ?> // ถ้าเงื่อนไข if ถ้ามี isset($_SESSION ['success']) จะทำให้เงื่อนไขนี้ไม่เป็นจริง false
          <div class="card3" style="height:400px;"> // คำสั่ง css โดยใช้ class ชื่อ card3
            ...
            <div class="list-group">
              <a href="weekstamp.php" // คำสั่ง route จากรูปภาพไปที่ weekstamp.php class="list-group-item list-group-item-action list-group-item-light">อัพโหลดรายงานประจำสัปดาห์</a>
              <a href="pageuser.php" // คำสั่ง route จากรูปภาพไปที่ pageuser.php class="list-group-item list-group-item-action list-group-item-light">แก้ไขข้อมูลประจำตัว</a>
              <a href="checkstatus.php" // คำสั่ง route จากรูปภาพไปที่ checkstatus.php class="list-group-item list-group-item-action list-group-item-light">ตรวจสอบสถานะ</a>
            </div>
          </div> // ปิดคำสั่ง css
        ...
        <div class="card2"> // คำสั่ง css โดยใช้ class ชื่อ card2
          ...
          <?php } else if ($_SESSION['status'] == 5) { ?> {?> // if ถ้า $_SESSION['status'] ไม่เท่ากับ 1 ถ้าแล้วมีค่า $_SESSION['status'] เท่ากับ 5 จะทำให้เงื่อนไขนี้เป็นจริง
            ...
            <div style="margin-left: 230px;"> // คำสั่ง css โดยใช้ class ชื่อ margin-left และเว้นระยะจากด้านซ้าย 230px
              <a class="btn btn-success" href="request-company-edit.php" role="button">แก้ไขข้อมูลติดต่อผู้ดูแลฝึกงานของสถานประกอบการ</a> // ลิ้งค์ route จากรูปภาพไปที่ request-company-edit.php
            </div>
          <?php } else { ?>
